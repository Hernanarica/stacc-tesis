...
{{-- Register local form --}}
		<div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
			<form action="{{ route('locals.create')}}" enctype="multipart/form-data" method="post" class="flex flex-col gap-4">
				<div class="text-center">
					<h2 class="text-4xl font-bold text-center text-gray-700">Registrar Local</h2>
				</div>
				@csrf
				<div class="form-row" >
				...
				<div class="form-row">
					<div class="col-12 col-md-5 mb-5">
						<label for="opening_time" class="form-label mb-1">
					...
					<div class="col-12 col-md-5 mb-5">
						<label for="closing_time" class="form-label mb-1">
				...
				<div class="form-row">
					<div class="col-12 col-md-5 mb-5">
						<label for="url_site" class="form-label mb-1">
				...
				<div class="form-row">
					<div class="col-12 col-md-5 mb-5">
						<label for="image" class="form-label mb-1">
					...
					<div class="col-12 col-md-5 mb-5">
						<label for="image_alt" class="form-label mb-1">
				...
				<div class="">
					<label for="url_map" class="form-label mb-1">
				...
				<div class="mt-6">
					<button type="submit" class="w-full px-4 py-2 tracking-wide text-white bg-gradient-to-r from-stacc-purple to-stacc-red rounded-md focus:outline-none focus:bg-blue-400 focus:ring focus:ring-blue-300 focus:ring-opacity-50">
						Registrar
					</button>
				</div>
			</form>
